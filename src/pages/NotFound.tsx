      ...
      <div className="flex flex-col items-center text-center max-w-2xl w-full relative z-10">
        ...
        <div className="relative w-96 h-96 mb-8 flex flex-col items-center justify-center">
          ...
          >
            ...
            {/* Side Handle */}
            <path
              d="M220 45 Q235 40 240 45 Q240 50 235 55 Q220 50 220 45"
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <path
                key={i}
                d={`M${135 + i * 10} 195 Q${140 + i * 10} 170 ${
                  130 + i * 10
                } 145 Q${145 + i * 10} 120 ${135 + i * 10} 105`}
        ...
        <div className="space-y-4 mb-10">
          ...
          <p className="text-gray-400">
            The link you brewed doesn't exist. Let's get back before the froth
            settles!
          </p>
        </div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(5, 12, 40, 0.2), rgba(10, 22, 84, 0.2))",
